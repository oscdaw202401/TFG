...
from Plazeduca.views import anadir_cita, anadir_trabajo_profesor, asignaturasProfesor, base, incidenciasAlumno, inicio,cerrarS, notasProfesor, trabajosProfesor,tutorCurso, asignaturas,notasAlumno,trabajosAlumno,encuesta, tutorCurso, tutoriaClase
urlpatterns = [
